...
def hash_name(name):
	""" Get an integer has from a given artist name
...
def importNPR(verbose=FALSE):
	""" Connect to the NPR API and pull data for every episode of the All Songs Considered Podcast.
	Use this data to construct an sqlite3 database consisting of all artists that have been featured,
	mapped to the date they appeard on and the show that they were in.

	TODO add flag for verbose output (log + console)
	TODO add duplicate artist checking
	TODO get MusicBrainz ID of each unique artist
